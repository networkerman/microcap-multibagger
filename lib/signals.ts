...
export const SIGNALS: Signal[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    verificationSteps: [
      { step: 1, action: "Visit the company's official website and document the client list, certifications, and awards displayed", source: "Company website — Clients / About / Certifications pages", evidenceRequired: "List of named clients and certifications" },
      { step: 2, action: "Check the annual report for customer concentration (top 5/10 customers % of revenue) and client names in the 'Risk Factors' and 'Business Overview' sections", source: "Annual report", evidenceRequired: "Customer concentration % and named clients" },
      { step: 3, action: "Search for regulatory approvals or certifications: RDSO, API, TPN, ISO, AS9100, EN 15085, IATF 16949, or sector-specific equivalents. Verify they are CURRENT (not expired)", source: "Company website, BSE filings, regulatory body websites", evidenceRequired: "Certification name, issuing body, validity status" },
      { step: 4, action: "Read the DRHP (if recently listed) or annual report for the 'Competition' section — identify the number and scale of direct competitors", source: "DRHP / Annual report — Competition section", evidenceRequired: "Number and names of direct competitors" },
      { step: 5, action: "Assess: how long would a well-funded new entrant take to replicate this company's position? <1 year = score 0-1, 1-3 years = score 2-3, 3+ years = score 4-5", source: "Synthesis of all above evidence", evidenceRequired: "Reasoned estimate with supporting evidence" },
    ],
